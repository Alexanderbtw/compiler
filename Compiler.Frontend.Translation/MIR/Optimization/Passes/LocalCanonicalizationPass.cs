            ...
            foreach (MirInstr instruction in block.Instructions)
            {
                switch (instruction)
                {
                    case Move move:
                    {
                        ...
                        rewrittenInstructions.Add(new Move(
                            Dst: move.Dst,
                            Src: source));
                    ...
                    case Bin binary:
                    {
                        ...
                        {
                            rewrittenInstructions.Add(new Bin(
                                Dst: binary.Dst,
                                Op: binary.Op,
                                L: left,
                                R: right));
                    ...
                    case Un unary:
                    {
                        ...
                        {
                            rewrittenInstructions.Add(new Un(
                                Dst: unary.Dst,
                                Op: unary.Op,
                                X: operand));
                    ...
                    case LoadIndex loadIndex:
                    {
                        ...
                        rewrittenInstructions.Add(new LoadIndex(
                            Dst: loadIndex.Dst,
                            Arr: arrayOperand,
                            Index: indexOperand));
                    ...
                    case StoreIndex storeIndex:
                    {
                        ...
                        rewrittenInstructions.Add(new StoreIndex(
                            Arr: arrayOperand,
                            Index: indexOperand,
                            Value: valueOperand));
                    ...
                    case Call call:
                    {
                        MOperand[] rewrittenArgs = call.Args
                        ...
                        rewrittenInstructions.Add(new Call(
                            Dst: call.Dst,
                            Callee: call.Callee,
                            Args: rewrittenArgs));
