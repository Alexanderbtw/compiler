...
/// <summary>
///     Experimental MIR type inference pass kept out of the main pipeline until
///     typing rules and backend consumers are stable.
/// </summary>
public sealed class MirTypeAnnotator
{
    ...
    {
        // Function parameters default to Obj and can be refined during the pass.
