...
public sealed class AstBuilder : MiniLangParserBaseVisitor<object>
{
    ...
    // ── New helper in AstBuilder (put near VisitExprList) ────────────
    ...
    // helper builds left-associative BinExpr chain
